 ...
 * ***************************************************************
 *
 * This class contains the class definition for a job Contains variables which define a job
 * including
 *
 * jobName: Is of the format J0, J1... and is assigned automatically by the job simulator.
 *
 * steps: percentage of job completed in the game at a given point of time.
 *
 * points: Total number of points awarded when the job is completed
 *
 * timeUnits: Total timeunits required to complete the job
 *
 * The class includes getter and setter methods and the toString function to print out the job
 * details.
 *
 */
public class Job {
	 ...
	 * 
	 * @param jobName
	 *            :Is of the format J0, J1... and is assigned automatically by the job simulator.
	 * @param points
	 *            :percentage of job completed in the game at a given point of time.
	 * @param timeUnits
	 *            :Total timeunits required to complete the job
	 */
	...
	public String toString() {
		return "Job Name: " + jobName + " Job Points: " + points + " Steps Remaining: "
				+ (this.timeUnits - this.steps);
	}
}